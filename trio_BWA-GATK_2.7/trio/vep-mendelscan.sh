...
/SSD750/PB1/soft1/annovar/convert2annovar.pl -format vcf4 $outdir/$sn.mendel.vcf -outfile $outdir/$sn.link --includeinfo
...
#cut -f 1,2,3,4,5,6 $outdir/$sn.avinput1|awk '{OFS="\t"}{print "chr"$1,$2,$3,$4,$5,$6}'|paste -d '' - $outdir/$sn.avinput2 > $outdir/$sn.avinput

#table_annovar.pl $outdir/$sn.avinput $ref_annotation -buildver hg19 -out $outdir/$sn.ann -protocol refGene,avsnp147,1000g2015aug_all,esp6500_all,exac03,dbnsfp33a,clinvar_20170130,ensembl,hgmd -operation g,f,f,f,f,f,f,f,f -remove -nastring "NA" -otherinfo
