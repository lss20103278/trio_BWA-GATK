...
#panel="$DB/refseq/hg19_SeqCap_EZ_Exome_v3_capture_plus20bp.bed"               # Roche WES
#panel="$DB/design/SCH.capture.hg19.20bp.bed"                                  #PANEL
#panel="$DB/refseq/Agilentinherited.bed"                                   #Agilent 2700 genes
#panel="/home/ana005/data/annovar/bed/IDT/IDT.bed"            #IDT 4500 genes
...
#panel="/DATA/sslyu/refGene/qianmai_blood_disease.bed" # blood_disease
