...
# for panel single
#cmd="clean mapping precalling gvcf gtgvcf hardfilt depth qcsum qcvcf annotation"
# for trio
#cmd="clean mapping precalling gvcf depth qcsum"
# for wxs single
cmd="clean mapping precalling gvcf gtgvcf vqsr depth qcsum qcvcf annotation"
:<<Note_pepline_main
...
perl /DATA/ypliu/opt/mskcc-vcf2maf-1b16b35/vcf2maf.pl --input-vcf $outdir/$sample.vcf --output-maf $outdir/$sample.maf --vep-path /DATA/ypliu/opt/mskcc-vcf2maf-1b16b35/vep --vep-data /DATA/ypliu/opt/mskcc-vcf2maf-1b16b35/.vep --ref-fasta /home/ana005/data/annovar/refGene/hg19.fa --filter-vcf /DATA/ypliu/opt/mskcc-vcf2maf-1b16b35/.vep/ExAC_nonTCGA.r0.3.1.sites.vep.vcf.gz
