#/DATA/ypliu/opt/R-3.4.3/bin/R --slave --vanilla < /DATA/sslyu/trio_BWA-GATK_3.0_20190122/src/CNV_Run.R > log 2>&1
...
#read.table("/DATA/sslyu/trio_BWA-GATK_3.0_20190122/doc/T084V2.ig.cnv.bed")->bed
#read.table("/DATA/sslyu/trio_BWA-GATK_3.0_20190122/doc/T084V2_CNV.igt.cnv.bed")->bed
...
#source("/DATA/sslyu/trio_BWA-GATK_3.0_20190122/src/CNV_Run.R")
q()
