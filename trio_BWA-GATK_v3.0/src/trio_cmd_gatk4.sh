...
if [ $var = 'peddy' ]
then
sh $basedir/trio_gatk4.sh $sample $SLURM_NPROCS
if [ -e pedtrio/results/peddy.ped_check.csv ]; then
...
curl 'https://oapi.dingtalk.com/robot/send?access_token=dc5bf30a873950e8c73bb37abf1851ebaf5d83f2792f08684ace2be621a12563' -H 'Content-Type: application/json' -d '{"msgtype": "text","text": {"content": "peddy error"}}'
fi
else
sh $basedir/trio_gatk4.sh $sample $SLURM_NPROCS $filtmode
