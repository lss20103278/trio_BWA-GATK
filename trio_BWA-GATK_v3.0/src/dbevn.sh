...
ref_genome_spark="/DATA/sslyu/refGene/hg19.2bit"
...
#panel="/DATA/sslyu/trio_BWA-GATK_v3.0/bed/T084V2.ig.bed" # T084V2
#panel="/DATA/sslyu/trio_BWA-GATK_v3.0/bed/T084V2_CNV.igt.bed" # T084V2_CNV
#panel="/DATA/sslyu/trio_BWA-GATK_v3.0/bed/T086V4.igt.bed" # T086V4
#panel="/DATA/sslyu/trio_BWA-GATK_v3.0/bed/IDTxGenExome2_exonsCDSmerged.bed" # IDT4 fujun whole-exome
