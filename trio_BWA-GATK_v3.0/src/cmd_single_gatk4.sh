...
sh run2_gatk4.sh $sample $SLURM_NPROCS
...
cd ../annotation
echo $sample >> list
python /DATA/sslyu/trio_BWA-GATK_v3.0/src/score_re.py -sn $sample
python /DATA/sslyu/trio_BWA-GATK_v3.0/src/annotation_filt.py -sn $sample -c_f_m c
